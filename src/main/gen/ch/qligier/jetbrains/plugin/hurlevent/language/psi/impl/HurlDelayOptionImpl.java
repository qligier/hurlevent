...
public class HurlDelayOptionImpl extends HurlPsiImplUtil implements HurlDelayOption {

  public HurlDelayOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitDelayOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTDelayOption() {
    return findNotNullChildByType(T_DELAY_OPTION);
  }
