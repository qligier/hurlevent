...
public class HurlCompressedOptionImpl extends HurlPsiImplUtil implements HurlCompressedOption {

  public HurlCompressedOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitCompressedOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTCompressedOption() {
    return findNotNullChildByType(T_COMPRESSED_OPTION);
  }
