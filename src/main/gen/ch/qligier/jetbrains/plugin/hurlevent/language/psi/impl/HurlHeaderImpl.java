...
public class HurlHeaderImpl extends HurlPsiImplUtil implements HurlHeader {

  public HurlHeaderImpl(ASTNode node) {
    super(node);
  }
  ...
  public HurlKeyValue getKeyValue() {
    return findNotNullChildByClass(HurlKeyValue.class);
  }
