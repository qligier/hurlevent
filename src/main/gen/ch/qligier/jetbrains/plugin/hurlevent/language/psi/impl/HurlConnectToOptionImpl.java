...
public class HurlConnectToOptionImpl extends HurlPsiImplUtil implements HurlConnectToOption {

  public HurlConnectToOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitConnectToOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTConnectToOption() {
    return findNotNullChildByType(T_CONNECT_TO_OPTION);
  }
