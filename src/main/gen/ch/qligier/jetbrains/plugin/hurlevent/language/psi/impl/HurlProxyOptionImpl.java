...
public class HurlProxyOptionImpl extends HurlPsiImplUtil implements HurlProxyOption {

  public HurlProxyOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitProxyOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTProxyOption() {
    return findNotNullChildByType(T_PROXY_OPTION);
  }
