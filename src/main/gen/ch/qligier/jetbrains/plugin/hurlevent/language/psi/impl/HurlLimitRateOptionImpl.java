...
public class HurlLimitRateOptionImpl extends HurlPsiImplUtil implements HurlLimitRateOption {

  public HurlLimitRateOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitLimitRateOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTLimitRateOption() {
    return findNotNullChildByType(T_LIMIT_RATE_OPTION);
  }
