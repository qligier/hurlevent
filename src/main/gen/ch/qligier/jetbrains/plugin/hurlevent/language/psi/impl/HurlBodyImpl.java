...
public class HurlBodyImpl extends HurlPsiImplUtil implements HurlBody {

  public HurlBodyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HurlBytes getBytes() {
    return findNotNullChildByClass(HurlBytes.class);
  }
