...
public class HurlEqualsPredicateImpl extends ASTWrapperPsiElement implements HurlEqualsPredicate {

  public HurlEqualsPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitEqualsPredicate(this);
  }
