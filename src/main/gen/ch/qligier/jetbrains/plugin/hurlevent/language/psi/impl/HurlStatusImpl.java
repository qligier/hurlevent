...
public class HurlStatusImpl extends HurlPsiImplUtil implements HurlStatus {

  public HurlStatusImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getTIntegerLiteral() {
    return findNotNullChildByType(T_INTEGER_LITERAL);
  }
