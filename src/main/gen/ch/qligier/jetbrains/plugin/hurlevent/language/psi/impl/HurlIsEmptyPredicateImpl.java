...
public class HurlIsEmptyPredicateImpl extends ASTWrapperPsiElement implements HurlIsEmptyPredicate {

  public HurlIsEmptyPredicateImpl(@NotNull ASTNode node) {
    super(node);
  }
