...
public class HurlQueryTargetImpl extends HurlPsiImplUtil implements HurlQueryTarget {

  public HurlQueryTargetImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitQueryTarget(this);
  }
