...
public class HurlVerboseOptionImpl extends HurlPsiImplUtil implements HurlVerboseOption {

  public HurlVerboseOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitVerboseOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTVerboseOption() {
    return findNotNullChildByType(T_VERBOSE_OPTION);
  }
