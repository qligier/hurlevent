...
public class HurlHeaderValImpl extends ASTWrapperPsiElement implements HurlHeaderVal {

  public HurlHeaderValImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitHeaderVal(this);
  }
