...
public class HurlKeyOptionImpl extends HurlPsiImplUtil implements HurlKeyOption {

  public HurlKeyOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitKeyOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTKeyOption() {
    return findNotNullChildByType(T_KEY_OPTION);
  }
