...
public class HurlRetryIntervalOptionImpl extends HurlPsiImplUtil implements HurlRetryIntervalOption {

  public HurlRetryIntervalOptionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTRetryIntervalOption() {
    return findNotNullChildByType(T_RETRY_INTERVAL_OPTION);
  }
