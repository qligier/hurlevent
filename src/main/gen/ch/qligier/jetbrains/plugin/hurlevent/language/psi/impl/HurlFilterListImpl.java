...
public class HurlFilterListImpl extends ASTWrapperPsiElement implements HurlFilterList {

  public HurlFilterListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitFilterList(this);
  }
