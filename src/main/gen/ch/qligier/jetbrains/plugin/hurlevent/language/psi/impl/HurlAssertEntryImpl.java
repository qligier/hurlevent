...
public class HurlAssertEntryImpl extends ASTWrapperPsiElement implements HurlAssertEntry {

  public HurlAssertEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitAssertEntry(this);
  }
