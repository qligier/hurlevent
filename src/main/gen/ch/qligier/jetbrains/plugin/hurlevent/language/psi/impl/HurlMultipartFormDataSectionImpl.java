...
public class HurlMultipartFormDataSectionImpl extends ASTWrapperPsiElement implements HurlMultipartFormDataSection {

  public HurlMultipartFormDataSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
