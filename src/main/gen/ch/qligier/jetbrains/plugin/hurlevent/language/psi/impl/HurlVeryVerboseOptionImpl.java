...
public class HurlVeryVerboseOptionImpl extends HurlPsiImplUtil implements HurlVeryVerboseOption {

  public HurlVeryVerboseOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitVeryVerboseOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTVeryVerboseOption() {
    return findNotNullChildByType(T_VERY_VERBOSE_OPTION);
  }
