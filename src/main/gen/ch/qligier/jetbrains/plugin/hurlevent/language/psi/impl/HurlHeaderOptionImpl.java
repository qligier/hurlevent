...
public class HurlHeaderOptionImpl extends HurlPsiImplUtil implements HurlHeaderOption {

  public HurlHeaderOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitHeaderOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTHeaderOption() {
    return findNotNullChildByType(T_HEADER_OPTION);
  }
