...
public class HurlUnixSocketOptionImpl extends HurlPsiImplUtil implements HurlUnixSocketOption {

  public HurlUnixSocketOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitUnixSocketOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTUnixSocketOption() {
    return findNotNullChildByType(T_UNIX_SOCKET_OPTION);
  }
