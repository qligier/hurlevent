...
public class HurlMaxTimeOptionImpl extends HurlPsiImplUtil implements HurlMaxTimeOption {

  public HurlMaxTimeOptionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HurlVisitor visitor) {
    visitor.visitMaxTimeOption(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getTMaxTimeOption() {
    return findNotNullChildByType(T_MAX_TIME_OPTION);
  }
