...
public class HurlOptionImpl extends HurlPsiImplUtil implements HurlOption {

  public HurlOptionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HurlOptionType getOptionType() {
    return findNotNullChildByClass(HurlOptionType.class);
  }
